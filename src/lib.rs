...
#[derive(Debug)]
pub struct ReactiveXProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ReactiveXProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ReactiveX processing");
    
    let mut processor = ReactiveXProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ReactiveXProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ReactiveXProcessor::new(false);
